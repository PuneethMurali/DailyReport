...
namespace Day14
{
    ...
    public class Account : ISavingsAccount, ICurrentAccount
    {
        ...
        {
            ISavingsAccount sa = new Account();
            sa.PrintAmountData();
            ICurrentAccount cs = new Account();
            cs.PrintAmountData();
        }
        void ICurrentAccount.PrintAmountData()
        {
            Console.WriteLine("current acc interface print data method");
        }
